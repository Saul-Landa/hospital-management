        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><g:message code="default.appointment.create.label"/></li>
                </ol>
            </nav>
        </div>
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><g:message code="default.appointment.create.label"/></h4>
                </div>
                <div class="card-body">
                    <g:form class="form" action="save" method="POST">
